...
public:
     ...
     */
    void RegisterSliceSubnet (uint8_t sliceId,
                              Ipv4Address network,
                              Ipv4Mask    mask);
     ...
     */
    void SlotStatsTraceSink (uint32_t sliceId, const SfnSf& sfnSf, uint32_t scheduledUe,
...
private:
    ...
    uint32_t m_maxSteps  {500};  ///< Episode length
